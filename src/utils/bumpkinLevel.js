/**
 * Tabela de XP Total necessária para alcançar cada nível no Sunflower Land.
 * Como o cálculo muda (crescimento linear, depois exponencial de 3%, etc), 
 * a maneira mais leve, exata e com melhor performance de calcular o nível 
 * é usando a tabela oficial pré-calculada em um array.
 * 
 * Um array com 200 números gasta menos de 1 KB de RAM, o que é infinitamente 
 * mais eficiente e seguro do que criar dezenas de "if/elses" matemáticos.
 */
const XP_TABLE = [
 ...
 */
export function getBumpkinLevel(experience) {
